...
$dbcon=mysqli_connect("localhost","root","","heeba");
mysqli_select_db($dbcon,"heeba");
...
exit();
    ...
    $run_query=mysqli_query($dbcon,"SELECT * from member WHERE user_name='$username'");
...
<!DOCTYPE html>
 ...
 <nav class="navbar navbar-default">
    ...
    <form action="hi.php" method="post" style="font-size:20px">
            ...
            <input type="username" name="username" id="username" placeholder="type your email here..."/>
